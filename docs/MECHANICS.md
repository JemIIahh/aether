...
For new mechanics to work with the The Aetherist, the agent needs expanded tools and context.
...
- [x] `spawn_prefab` + `destroy_prefab` agent tools in `config/aetherist/game-world-skill.js`
