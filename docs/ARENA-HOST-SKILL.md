...
```bash
curl -X POST https://aether.example/api/arenas \
...
```bash
curl https://aether.example/api/arenas/YOUR_ARENA_ID/agent/context \
...
```bash
curl -X POST https://aether.example/api/arenas/YOUR_ARENA_ID/world/compose \
  -H "Content-Type: application/json" \
  -H "X-Arena-API-Key: YOUR_API_KEY" \
...
```bash
curl -X POST https://aether.example/api/arenas/YOUR_ARENA_ID/game/start \
  -H "Content-Type: application/json" \
  -H "X-Arena-API-Key: YOUR_API_KEY" \
...
BASE = "https://aether.example/api/arenas/YOUR_ARENA_ID"
...
```bash
curl -X DELETE https://aether.example/api/arenas/YOUR_ARENA_ID \
  -H "X-Arena-API-Key: YOUR_API_KEY"
```
