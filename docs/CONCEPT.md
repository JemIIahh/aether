...
- Interact with the The Aetherist through gameplay
...
Mid-game events the Aetherist can add with triggers:
...
Players spend tokens (starting balance: 1000) to influence the Aetherist:
...
Simple bribes execute immediately. Complex bribes are queued for the Aetherist to honor or ignore.

### Floor System

Three floor types the Aetherist can toggle:
- `solid`: normal ground
