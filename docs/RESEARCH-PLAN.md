...
### Clarified Vision
- **Agent = The Aetherist**: The AI has a visible avatar in the world
...
|-------|------|--------------|
| **Builder (The Aetherist)** | Creates world, modifies physics | Spawn objects, change gravity, create challenges |
  ...
  processing: {
    builderAgent: {
      ...
      promptTemplate: `
        ...
        As the The Aetherist, choose what to build/modify next.
...
│   What should the The Aetherist do next?"                  │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
