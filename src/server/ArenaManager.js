 ...
 * Creates a default "aether" arena on initialization.
 */
...
export class ArenaManager {
  constructor() {
    this.arenas = new Map();
    this.defaultArenaId = 'aether';
  }

  createDefaultArena(config = {}) {
    const arena = new ArenaInstance('aether', {
      name: 'Aether',
      description: 'The default Aether arena',
      gameMasterName: 'The Aetherist',
      isDefault: true,
      ...config,
    });
    this.arenas.set('aether', arena);
    console.log('[ArenaManager] Default "aether" arena created');
    return arena;
  }
